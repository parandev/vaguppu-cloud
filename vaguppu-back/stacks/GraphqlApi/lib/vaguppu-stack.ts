...
export class VaguppuStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    putEventResolver.addDependency(dataSource);

    // Output the resolver ARN for reference
    new cdk.CfnOutput(this, 'PutEventMutationResolverArn', {
      value: putEventResolver.attrResolverArn,
      description: 'The ARN of the PutEvent Mutation Resolver',
    });
...
new VaguppuStack(app, "AppSyncEventBridge");
app.synth();